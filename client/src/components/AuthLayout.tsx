      ...
      <section className="relative hidden overflow-hidden bg-[#edf4ff] lg:block">
        ...
        <div className="relative flex h-full min-h-screen flex-col justify-between p-12 xl:p-20">
          ...
          <div className="relative mx-auto w-full max-w-[570px]">
            <img src="/manus-storage/onfon-next-auth-signal_b86be646.png" alt="Abstract Onfon Next signal field" className="absolute -inset-20 h-[calc(100%+10rem)] w-[calc(100%+10rem)] object-cover opacity-85 mix-blend-multiply" />

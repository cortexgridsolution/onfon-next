...
export default function BrandMark({ compact = false, light = false, href = "/" }: BrandMarkProps) {
  return (
    <Link href={href} className="inline-flex items-center gap-2.5 group" aria-label="Onfon Next home">
      <img src="/manus-storage/onfon-next-mark-red-black_b74af078.png" alt="" className={`${compact ? "h-8 w-8" : "h-9 w-9"} rounded-[9px] object-contain transition-transform duration-200 group-hover:-translate-y-0.5`} />
